    ...
    public partial class _1 : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                .PrimaryKey(t => new { t.Professor_ProfessorID, t.Course_CourseID })
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.ProfessorCourses", "Course_CourseID", "dbo.Courses");
            DropForeignKey("dbo.ProfessorCourses", "Professor_ProfessorID", "dbo.Professors");
            ...
            DropIndex("dbo.ProfessorCourses", new[] { "Course_CourseID" });
            DropIndex("dbo.ProfessorCourses", new[] { "Professor_ProfessorID" });
